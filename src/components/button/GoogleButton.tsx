...
const GoogleLoginButton: React.FC = () => {
  ...
  return (
    <button className={s.gsiMaterialButton} onClick={() => login()}>
      <div className={s.gsiMaterialButtonState}></div>
      <div className={s.gsiMaterialButtonContentWrapper}>
        <div className={s.gsiMaterialButtonIcon}>
        ...
        <span className={s.gsiMaterialButtonContents}>Sign in with Google</span>
